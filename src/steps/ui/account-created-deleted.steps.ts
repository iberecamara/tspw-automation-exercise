import { CREATED, SECOND_IN_MILISSECONDS } from '@data/constants/common.constants';
...
export class AccountCreatedDeletedSteps extends BaseSteps {
    ...
    async clickContinue(page: string): Promise<void> {
        ...
        await test.step(`Click Continue in Account ${page} page`, async () => {
            ...
            await this.accountCreatedDeletedPage.page.waitForLoadState('load', { timeout: 15 * SECOND_IN_MILISSECONDS });
        });
