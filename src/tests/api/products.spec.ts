...
test.describe(
  ...
  () => {
    test(
      ...
      async ({ productApiSteps }) => {
        const response: CustomResponseType = (await productApiSteps.all({
          raw: true,
    ...
    test(
      ...
      async ({ productApiSteps }) => {
        const search = "tshirt";
        const response: CustomResponseType = (await productApiSteps.search({
          raw: true,
          search: search,
        })) as CustomResponseType;
        await productApiSteps.validateGetAllProducts(response, {
